package com.ziadsyahrul.tugasmvp.adapter;
...
import com.ziadsyahrul.tugasmvp.view.DetailActivity;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_football_list, viewGroup, false));
    }
